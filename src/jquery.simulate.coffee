...
jasmine.features.addSimulate = ($) ->
  ...
  $.simulate = (el, type, options) ->
    ...
    else if type == "focus" or type == "blur"
      this[type]()
    else
  ...
  $.extend $.simulate::,
    ...
    mouseEvent: (type, options) ->
      ...
      if $.isFunction(document.createEvent)
        ...
        if evt.pageX == 0 and evt.pageY == 0 and Object.defineProperty
          eventDoc = evt.relatedTarget.ownerDocument or document
          doc = eventDoc.documentElement
          body = eventDoc.body
          Object.defineProperty evt, "pageX", get: ->
            e.clientX + (doc and doc.scrollLeft or body and body.scrollLeft or 0) - (doc and doc.clientLeft or body and body.clientLeft or 0)

          Object.defineProperty evt, "pageY", get: ->
            e.clientY + (doc and doc.scrollTop or body and body.scrollTop or 0) - (doc and doc.clientTop or body and body.clientTop or 0)
    ...
    blur: ->
      ...
      element[0].blur()
      setTimeout (->
        element[0].ownerDocument.body.focus()  if element[0].ownerDocument.activeElement == element[0]
        unless triggered
